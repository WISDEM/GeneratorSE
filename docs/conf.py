...
codeName = u'GeneratorSE'
authorName = u'Latha Sethuraman and Katherine Dykes'
...
.. role:: bib
   :class: bib
"""  # define bibliography type and corresponding css class
# intersphinx_mapping = {'airfoilprep': ('airfoilpreppy-docs', None)}
...
htmlhelp_basename = codeName + 'doc'
...
latex_documents = [
    ('index', codeName + '.tex', codeName + ' Documentation',
     authorName, 'manual'),
]
...
man_pages = [
    ('index', codeName, codeName + ' Documentation',
     [authorName], 1)
]
...
texinfo_documents = [
    ('index', codeName, codeName + ' Documentation',
     authorName, codeName, 'One line description of project.',
     'Miscellaneous'),
]
