...
class SCIG(Component):
   """ Estimates overall mass and dimensions of SCIG generator. """
...
class SCIG_Cost(Component):
   ...
   Copper=Float(0.0,iotype='in', desc='Copper mass')
   Iron=Float(0.0,iotype='in', desc='Iron mass')
   M_Str=Float(0.0,iotype='in', desc='Structural mass')
...
class SCIG_Opt(Assembly):
    ...
    def __init__(self,Optimiser='',Objective_function='',print_results=''):
        ...
        self.connect('SCIG.M_Str','SCIG_Cost.M_Str')
...
def SCIG_Opt_example():
    ...
    opt_problem = SCIG_Opt('CONMINdriver','Costs',1)
