...
def write_all_data(prob, output_dir=None):
    ...
    raw_data = [
        ...
        ["Circumferential arm space constraint (<1)"          , "con_bar"           , float(prob.get_val("con_bar")), "-", "< 1.0"],
        ["Circumferential arm space constraint (<1)"          , "con_bas"           , float(prob.get_val("con_bas")), "-", "< 1.0"],
        ["Radial deflection constraint-rotor (<1)"            , "con_uar"           , float(prob.get_val("con_uar")), "-", "< 1.0"],
        ["Radial deflection constraint-rotor (<1)"            , "con_uas"           , float(prob.get_val("con_uas")), "-", "< 1.0"],
        ["Axial deflection constraint-rotor (<1)"             , "con_yar"           , float(prob.get_val("con_yar")), "-", "< 1.0"],
        ["Axial deflection constraint-rotor (<1)"             , "con_yas"           , float(prob.get_val("con_yas")), "-", "< 1.0"],
        ["Torsional deflection constraint-rotor (<1)"         , "con_zar"           , float(prob.get_val("con_zar")), "-", "< 1.0"],
        ["Torsional deflection constraint-rotor (<1)"         , "con_zas"           , float(prob.get_val("con_zas")), "-", "< 1.0"],
