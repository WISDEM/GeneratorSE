...
import ipm.magnetics_design as md
...
class PMSG_Outer_rotor_Opt(om.Group):
    ...
    def setup(self):
        ...
        ivcs.add_output('h_m', 0.0,units="m",desc='pole height' )
        ivcs.add_output('alpha_v', 0.0,units='deg',desc='V-angle' )
        #ivcs.add_output('ratio', 0.0,desc='magnet width to bridge ratio' )
...
#        ivcs.add_output('h_sr', 0.0,units='m',desc='Rotor rim thickness')
        ivcs.add_output('w_fe', 0.0, units="m", desc="distance from air gap radius ")
